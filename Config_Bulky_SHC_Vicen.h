...
#define DISPLAY_OLED                 OLED_SSD1309 // SH1106, OLED 1.3" I2C display commonly used. SSD1306 is a 0.96" OLED display.    Infreq
...
#define BUTTON_DEBOUNCE_MS 80    // default was 30ms
