...
// SERIAL PORTS --------------------------------------------------------------------------------------------------------------------
#define SERIAL_ONSTEP          SERIAL_IP // .._ST4, Allow SERIAL_ST4 OnStep connections using its ST4 port synchronous       Infreq
...
#define SERIAL_RADIO           WIFI_STATION //    OFF, Allow BLUETOOTH, WIFI_STATION, or BOTH OnStep connections (ESP32 only.)  Option
...
#define DISPLAY_CONTRAST_DEFAULT      3 //      1, Use 0 to 3 for Min, Low, High, Max respectively.                         Option
...
#define B_PIN4_ACTIVE_STATE HIGH // default was LOW
